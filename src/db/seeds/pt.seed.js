      ...
      content: [
        {
          ...
          link: 'https://ualendarizacion-uam.web.app/'
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          link: 'https://mediuam.onrender.com'
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          technologies: 'PHP',
          link: 'http://148.206.168.174/conferpass/public/'
        }
      ]
    },
    {
      ...
      content: [
        {
          ...
          technologies: 'React y Firebase',
          link: 'https://futbol-master.vercel.app/login'
        }
      ]
    },
    {
...
async function seed() {
    try {
        ...
        await PT.insertMany(seedPTs.reverse())
